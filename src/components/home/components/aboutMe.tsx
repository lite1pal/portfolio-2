...
export default function AboutMe({ toPDF }: Props) {
  return (
    <div id="aboutme" className="flex flex-col items-center gap-10">
      ...
      <div className="flex flex-col gap-16 lg:flex-row lg:gap-36">
        <div className="flex flex-col items-center gap-10">
          ...
          <div className="mx-auto flex gap-6 text-primary dark:text-primary-dark">
            ...
            <a target="_blank" href="https://twitter.com/lite_pal">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 248 204"
                fill="currentColor"
            ...
            <a target="_blank" href="mailto:deniskatarasenko6@gmail.com">
              <svg
                fill="currentColor"
                className="group h-6 w-6"
                viewBox="0 0 32 32"
